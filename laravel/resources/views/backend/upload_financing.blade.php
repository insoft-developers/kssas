                        ...
                        <div class="row">
                            ...
                            <div style="margin-top:30px;" class="col-md-12">
                                <div class="table-responsive">
                                    <table id="table_upload_pembiayaan"
                                        ...
                                        <tbody>
                                            ...
                                            @foreach ($upload as $u)
                                                @php
                                                    ...
                                                    $cust = \App\Models\Customer::where('id', $u->customer_id_pinjaman);
                                                    if ($cust->count() > 0) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td>{{ $cust_name }}</td>
                                                    <td>{{ $product_name }}</td>
                                                    <td style="text-align:right;">{{ number_format($u->nilai_pengajuan) }}
                                                    </td>
                                                    <td style="text-align:right;">{{ number_format($u->dp) }}</td>
                                                    <td style="text-align:right;">{{ number_format($u->total_harga) }}</td>
                                                    <td style="text-align:right;">{{ number_format($u->sisa_dibayar) }}
                                                    </td>
                                                    <td style="text-align:right;">{{ number_format($u->periode) }}</td>
                                                    <td style="text-align:right;">{{ number_format($u->angsuran_pokok) }}
                                                    </td>
                                                    <td style="text-align:right;">{{ number_format($u->nilai_pengajuan) }}
                                                    </td>
                                                    <td style="text-align:right;">{{ number_format($u->nilai_pengajuan) }}
