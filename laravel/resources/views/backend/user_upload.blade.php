                                    ...
                                    <tbody>
                                        @foreach ($data as $index => $d)
                                            <tr>
                                                ...
                                                @if (!empty($d->foto))
                                                    <td><a href="{{ asset('template/frontend/images/form-pendaftaran/' . $d->foto) }}"
                                                            target="_blank"><img class="img-customer"
                                                                src="{{ asset('template/frontend/images/form-pendaftaran/' . $d->foto) }}"></a>
                                                    </td>
                                                @else
                                                    <td></td>
                                                @endif
                                                ...
                                                <td>
                                                    <center><a title="Edit" onclick="editForm({{ $d->id }})"
                                                            style="width:25px;margin-bottom:3px;"
                                                            class="btn btn-success btn-xs"><i
                                                                class="glyphicon glyphicon-check"></i></a><br><a
                                                            title="Hapus" onclick="deleteData({{ $d->id }})"
                                                            style="width:25px;margin-bottom:3px;"
                                                            class="btn btn-danger btn-xs"><i
                                                                class="glyphicon glyphicon-trash"></i></a></center>
