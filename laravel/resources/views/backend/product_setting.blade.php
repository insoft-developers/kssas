...
<h1>Setting Produk Pembiayaan</h1>
<ol class="breadcrumb">
	<li>
	...
	<li class="active">Setting Produk Pembiayaan</li>
</ol>
</section>
	...
	<div class="col-xs-12">
		<div class="box">
			...
			<div class="box-body">
				<div class="row">
					<div class="col-md-12">
						<table class="table table-bordered table-striped table-cantik" id="table_product_setting">
						<thead>
						<tr>
							<th width="5%">#</th>
							<th width="*">Produk</th>
