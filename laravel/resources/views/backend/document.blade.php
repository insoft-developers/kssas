...
<ol class="breadcrumb">
	...
	<li class="active">Dokumen Legal</li>
</ol>
</section>
	...
	<div class="col-xs-12">
		<div class="box">
			...
			<div class="box-body">
				<div class="row">
					<div class="col-md-12">
						<table class="table table-bordered table-striped table-cantik" id="table_document">
						<thead>
						<tr>
							<th>#</th>
							<th>Nama Dokumen</th>
			...
			<form id="form-tambah" method="post" class="form-horizontal" enctype="multipart/form-data">
				...
				<div class="modal-body">
					...
					<div class="form-group">
						...
						<div class="col-md-8">
							<textarea class="form-control" id="document_name" name="document_name" required></textarea>
							</div>
					</div>
					<div class="form-group">
						<label class="col-md-3 control-label">Link Dokumen :</label>
						<div class="col-md-8">
							<textarea class="form-control" id="document_link" name="document_link" required></textarea>
							</div>
					</div>
