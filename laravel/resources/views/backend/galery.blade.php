...
<ol class="breadcrumb">
	...
	<li class="active">RAT Gallery</li>
</ol>
</section>
	...
	<div class="col-xs-12">
		<div class="box">
			...
			<div class="box-body">
				<div class="row">
					<div class="col-md-12">
						<table class="table table-bordered table-striped table-cantik" id="table_galery">
						<thead>
						<tr>
							<th width="5%">#</th>
							<th width="*">Foto RAT</th>
			...
			<form id="form-tambah" method="post" class="form-horizontal" enctype="multipart/form-data">
				...
				<div class="modal-body">
					...
					<div class="form-group">
						<label class="col-md-3 control-label">Foto RAT :</label>
						<div class="col-md-8">
